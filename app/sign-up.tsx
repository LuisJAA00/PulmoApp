...
const SignUp = () => {
    ...
    return (
        <View className="h-full bg-white">
            <TitleCard title="Sign Up" /> {/* TitleCard component */}
            ...
            <SafeAreaView className='bg-white h-full'>
                <ScrollView contentContainerStyle={{ flexGrow: 1, paddingTop: 0 }}> {/* Removed default padding-top */}
                    <View className="px-10 mt-8"> {/* Increased margin-top from mt-2 to mt-5 */}
                        ...
                        <View className="mt-5">
                            <Text className='text-lg font-rubik text-black-200'>Confirm Password</Text>
                            <TextInput
                                className='border border-gray-300 rounded-lg p-3 mt-2'
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={() => Alert.alert('Sign Up', 'Sign Up logic here')}
                        >
